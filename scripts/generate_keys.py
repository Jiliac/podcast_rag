...
def generate_and_save_keys():
    ...
    print("✅ Successfully generated 'private_key.pem' and 'public_key.pem' in the project root.")
    print("\nNext steps:")
    print("1. Manually copy 'private_key.pem' to the 'mcp-client/' directory.")
    print("   cp private_key.pem mcp-client/private_key.pem")
    print("2. The 'public_key.pem' is used by the server and should remain in the root.")
    print("3. Ensure '*.pem' is added to your root .gitignore file to avoid committing keys.")
